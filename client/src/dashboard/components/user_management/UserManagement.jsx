...
console.log(appState)
  ...
  return (
    <>
      ...
      <div className="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-6 lg:py-6">
...
<section className="container px-4 mx-auto mt-8">
    <div className="flex items-center gap-x-3">
        ...
        <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full  ">100 users</span>
    </div>
    ...
    function ActionCard() {
        return <div className="flex max-w-md overflow-hidden bg-white rounded-lg shadow-lg">
            ...
            <div className=" p-5 bg-gray-100">
                ...
                <div className="flex justify-between mt-3 item-center">
                    ...
                    <Link to="add-new-employee" className="px-3 py-2 text-xs font-bold text-white uppercase bg-gray-800 rounded">
                        Employee Form
                    </Link>
                </div>
            </div>
